...
OmegaNumOptimizer.monitor = {
    ...
    logReport() {
        ...
        console.log('=== OmegaNum性能报告 ===');
        console.log(`运行时间: ${report.runtime}ms`);
        console.log(`总调用次数: ${report.totalCalls}`);
        console.log(`缓存命中: ${report.cacheHits} (${report.cacheHitRate})`);
        console.log(`对象池命中: ${report.poolHits} (${report.poolHitRate})`);
        console.log(`新建实例: ${report.newInstances}`);
        console.log(`每秒调用: ${report.callsPerSecond}`);
        console.log('=======================');
    }
};
